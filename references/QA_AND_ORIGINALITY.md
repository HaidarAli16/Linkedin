# QA and originality review

## Visual originality

For each reference, record two brief notes in the generation prompt:

- **Allowed lessons:** the abstract properties that may carry over, such as hierarchy, material, contrast, density, palette family, image treatment, or diagram grammar.
- **Forbidden literals:** source wording, logos, handles, page counters, platform UI, exact composition, distinctive objects, repeated diagram shapes, and creator identity.

The actual topic must determine the new visual metaphor, proof object, and focal balance. A carousel should feel coherent through a system of type classes, palette, margins, and recurring light-touch motif—not through cloned slide layouts.
